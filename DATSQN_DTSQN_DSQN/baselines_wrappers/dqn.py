...
class Network(nn.Module):
    ...
    def save(self, save_path):
        params = {k: t.detach().cpu().numpy() for k, t in self.state_dict().item()}
...
make_env= make_atari_env('Breakout-v0',n_envs=4, seed=0)
#env=DummyVecEnv([make_env for _ in range(NUM_ENV)])
