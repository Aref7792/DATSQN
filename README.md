...
To test a trained model: put the model in the training_models directory. Open the related test environment: DATSQN-test.py or DTSQN-test.py or DSQN-test.py. Enter the digit part of the model name (digits after "dqn") to   
